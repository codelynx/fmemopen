...
//! Project version number for fmemopen.
FOUNDATION_EXPORT double fmemopenVersionNumber;

//! Project version string for fmemopen.
FOUNDATION_EXPORT const unsigned char fmemopenVersionString[];
